...
Generally, this tool is intended to be used as and when users come across CCS values in the literature i.e. when you see a paper with a CCS value for a biomacromolecule, log it. To speed things up in the early stages, a database of papers in the field of native ion mobility mass spectrometry papers is also provided (`native_IM_MS_papers_20251215.csv`). Users can select a paper at random to log.
